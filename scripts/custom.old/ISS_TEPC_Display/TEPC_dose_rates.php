...
try {
	...
	drupal_add_js('/sites/all/modules/CUSTOM/srag_chart/LLPlot.js','file'); 
} catch(Exception $e) {
	echo 'Caught exception: ',  $e->getMessage(), "\n";
}
?>
...
<canvas style="background-image:url('/sites/default/files/world766x400.jpg');" id="llplot" width="766" height="400"></canvas>
 
<br>

<img src="/sites/default/files/DoseLegend.jpg" width="793" height="24" border="0" alt="Dose Legend"><br>
<img src="/sites/default/files/DoseLegend2.jpg" width="114" height="31" border="0" alt="Dose Legend2">
</div>
